...
local dtc_calls = { button = 0, grid = 0, grid_header = 0, separator = 0,
                    coal_red = 0, coal_blue = 0, coal_neutral = 0 }
...
-- Case 7a: dtc_coal_red routes to dtc_skins.coal_red().
do
    local w = make_widget()
...
-- Case 7b: dtc_coal_blue routes to dtc_skins.coal_blue().
do
    local w = make_widget()
...
-- Case 7c: dtc_coal_neutral routes to dtc_skins.coal_neutral().
do
    local w = make_widget()
