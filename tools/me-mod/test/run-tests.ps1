...
try {
    ...
    $tests = @('test_airbase_detect.lua', 'test_bridge_gen_counter.lua', 'test_context_menu_clipboard.lua', 'test_distill_parity.lua', 'test_filter_rows.lua', 'test_marquee_hook.lua', 'test_paths_folder.lua', 'test_prefab_ops_airbases.lua', 'test_prefab_ops_delete_folder.lua', 'test_prefab_ops_folder_validate.lua', 'test_prefab_ops_load.lua', 'test_prefab_ops_move.lua', 'test_prefab_ops_place.lua', 'test_prefab_ops_rename_file.lua', 'test_prefab_ops_rename_folder.lua', 'test_prefab_ops_save.lua', 'test_prefab_ops_scan_migrate.lua', 'test_prefab_ops_scan_recursive.lua', 'test_serializer.lua', 'test_serializer_parity.lua', 'test_ship_warehouse.lua', 'test_sms_window.lua', 'test_undo.lua', 'test_warehouse_ops.lua', 'test_verbs_aggregator.lua', 'test_verbs_airbase.lua', 'test_verbs_camera.lua', 'test_verbs_coords.lua', 'test_verbs_drawing.lua', 'test_verbs_file.lua', 'test_verbs_group.lua', 'test_verbs_resources.lua', 'test_verbs_route.lua', 'test_verbs_trigger.lua', 'test_verbs_unit.lua', 'test_verbs_zone.lua')
    $anyFailed = $false
    foreach ($t in $tests) {
