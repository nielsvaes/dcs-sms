...
try {
    ...
    $tests = @('test_airbase_detect.lua', 'test_context_menu_clipboard.lua', 'test_distill_parity.lua', 'test_filter_rows.lua', 'test_group_name_writer.lua', 'test_marquee_hook.lua', 'test_mass_edit_add_prefix_group_name.lua', 'test_mass_edit_add_suffix_group_name.lua', 'test_mass_edit_airbase_marquee.lua', 'test_mass_edit_auto_name_units_group.lua', 'test_mass_edit_export_import_warehouse_airbase.lua', 'test_mass_edit_find_replace_group_name.lua', 'test_mass_edit_forms.lua', 'test_mass_edit_map_sync.lua', 'test_mass_edit_rename_group.lua', 'test_mass_edit_set_coalition_airbase.lua', 'test_mass_edit_set_country.lua', 'test_mass_edit_set_warehouse_airbase.lua', 'test_mass_edit_toggle_group_flags.lua', 'test_mass_edit_transforms.lua', 'test_tri_state_button.lua', 'test_me_camera.lua', 'test_me_group_focus.lua', 'test_me_refresh.lua', 'test_me_select_writer.lua', 'test_paths_folder.lua', 'test_prefab_ops_airbases.lua', 'test_prefab_ops_delete_folder.lua', 'test_prefab_ops_folder_validate.lua', 'test_prefab_ops_load.lua', 'test_prefab_ops_move.lua', 'test_prefab_ops_place.lua', 'test_prefab_ops_rename_file.lua', 'test_prefab_ops_rename_folder.lua', 'test_prefab_ops_save.lua', 'test_prefab_ops_scan_migrate.lua', 'test_prefab_ops_scan_recursive.lua', 'test_selection_drilled.lua', 'test_selection_snapshot_airbases.lua', 'test_selection_snapshot_mission.lua', 'test_serializer.lua', 'test_serializer_parity.lua', 'test_ship_warehouse.lua', 'test_skin_helper.lua', 'test_sms_window.lua', 'test_splitter.lua', 'test_undo.lua', 'test_warehouse_ops.lua', 'test_verbs_route.lua')
    $anyFailed = $false
    foreach ($t in $tests) {
