...
| [`set-dcs-path`](set-dcs-path.md) | pin the DCS install folder in config (run bare to show the current one) |
| [`set-saved-games`](set-saved-games.md) | pin the DCS Saved Games folder in config (run bare to list the folders found) |
